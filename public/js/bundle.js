        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: 'http://localhost:4040/api/v1/users/login',
              data: {
                email: email,
                password: password
              }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: 'http://localhost:4040/api/v1/users/signup',
              data: {
                name: name,
                email: email,
                password: password,
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: 'http://localhost:4040/api/v1/users/logout'
            });
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://localhost:4040/api/v1/users/updateMyPassword' : 'http://localhost:4040/api/v1/users/updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
var stripe = Stripe('pk_test_51H5FCMGTmZGEAj5NNqOHqd4XSP9vsopiRiSkWfJCD5yyM2kniuEUlehH9ZIHMzMy2gqM93tBRokN8OQLMJPRfGLF00jII2n972');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://localhost:4040/api/v1/bookings/checkout-session/".concat(tourId));
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    ...
    var email = document.getElementById('email').value;
    if (password !== passwordConfirm) return (0, _alert.showAlert)('error', "Password and Confirm Password dosen't match");
